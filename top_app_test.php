...
<html>
  <head>
    <title>Extracted Data Table (smshub_Jikatel)</title> 
    <meta charset="utf-8">
  ...
  <body>
    <div class="container">
      <h2>Extracted Data Table (smshub_Jikatel)</h2>
    ...
    <div class="col-md-3">
      <div class="dropdown">
        ...
        <li><a href="#" data-value="1">Jikatel</a></li>
      <li><a href="#" data-value="2">lnovaro</a></li>
      <li><a href="#" data-value="3">saliba</a></li>
      <li><a href="#" data-value="4">digitalsim</a></li>
      <li><a href="#" data-value="5">All</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-2">
