...
<head>
    ...
    <title>SMS GoOnline - Index</title>
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <!-- <h1 class="logo mr-auto"><a href="index.php">Butterfly</a></h1> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>better choice for your business</h1>
                    <h2>sms.goonline.company </h2>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <img src="assets/img/main/WhatsApp-Marketing.jpg" class="img-fluid" alt="">
