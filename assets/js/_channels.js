...
function retreive_data() {
    ...
    var response2 = $.get("clientfxn/get_channels.php?count=1", function(data) {
        ...
        if (remote_length != data_length || pendging_count != pend) {
...
function getData() {
    ...
    myTable = $('#dataTable').DataTable({
        ...
        ajax: {
            url: "clientfxn/get_channels.php",
...
function DownloadChannel(filename) {
    ...
    var url = "clientfxn/channel-download.php?fname=" + filename;
...
function Convert(filename) {
    var req = new XMLHttpRequest();
    var url = "clientfxn/channel-download.php?fname=" + filename + "&convert=1";
...
function ShowOnline(filename) {
    ...
    mapForm.method = "POST";
    mapForm.action = "clientfxn/showchannels.php";
...
function SendRequst() {
    var cnt = $("#CountNB").val();
    var counteris = $('#country_list option:selected').val();
...
function FireCancel(name){
    $.ajax({
        method: 'POST',
        url: 'clientfxn/CancelRequest.php',
        data: {
            Name: name,
        },
        success: function(data) {
