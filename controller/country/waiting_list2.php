                ...
                <tbody>
                    <?php foreach ($itemTotals as $row) : ?>
                        <tr>
                            ...
                            <td>
                            <button class="btn btn-success" onclick="Download('<?php echo "?code=" . urlencode($_GET['code']) . "&action=download&source=" . urlencode($row['source']); ?>','<?php echo $row['source']; ?>')">
                                <i class="fas fa-cloud-download-alt"></i> <!-- Cloud icon from Font Awesome -->
                            </button>
                            </td>
                            <td>
                                <button class="btn btn-danger" onclick="confirmDelete('<?php echo "?code=" . urlencode($_GET['code']) . "&action=delete&source=" . urlencode($row['source']); ?>','<?php echo $row['source']; ?>')"> <i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
