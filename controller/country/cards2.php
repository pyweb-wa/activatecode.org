                ...
                <div class="card card-solid">
                    ...
                    <table class="styled-table">
                        ...
                        <tr>
                            <td>Nginx Threads</td>
                            <td ng-class="{ 
                                        'alert-green': serv_loads[0].active_connections <= 100,
                                        'flash-alert-war': serv_loads[0].active_connections > 100 && serv_loads[0].active_connections < 120,
                                        'flash-alert-dang': serv_loads[0].active_connections >= 120
                                        }">
                                {{ serv_loads[0].active_connections }}
                            </td>
                            <td ng-class="{ 
                                        'alert-green': serv_loads[1].active_connections <= 100,
                                        'flash-alert-war': serv_loads[1].active_connections > 100 && serv_loads[1].active_connections < 120,
                                        'flash-alert-dang': serv_loads[1].active_connections >= 120
                                        }">
                                {{ serv_loads[1].active_connections }}
                            </td>
                            <td ng-class="{ 
                                        'alert-green': serv_loads[2].active_connections <= 100,
                                        'flash-alert-war': serv_loads[2].active_connections > 100 && serv_loads[2].active_connections < 120,
                                        'flash-alert-dang': serv_loads[2].active_connections >= 120
                                        }">
                            ...
                            <div ng-repeat="country in countries" class="col-12 col-sm-6 col-md-3 d-flex align-items-stretch flex-column">
                                <div class="card bg-light d-flex flex-fill">
                                    <div class="card-header  text-muted border-bottom-0 d-flex" ng-class="country.available == '0' ? 'bg-danger':((country.available <= 500 )? 'bg-warning':'bg-primary') ">
                                        <h2 class="lead text-white "> <b>{{country.country}} {{country.country_code}}_{{country.country_char}} </b></h2>
...
<script src="./js/CountryController2.js"></script>
