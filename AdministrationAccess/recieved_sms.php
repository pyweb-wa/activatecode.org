...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Recevied SMS</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">SMS</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <script src="assets/js/recieved_sms.js"></script>
    <script>
        $(document).ready(function() {
            $('#table_id').DataTable({
                ...
                ajax: '../AdministrationAccess/servicesfxn/getrecievedsms.php',
            });
        });
    </script>
