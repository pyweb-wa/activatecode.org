...
<body id="page-top">
                ...
                <div class="container-fluid"> 
                    <div class="card shadow mt-3">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Supervisors info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                                    ...
                                                    <div class="modal-body">
                                                        <form role="form">
                                                            <div class="form-group">
                                                                <label for="api"><span class="glyphicon glyphicon-user"></span> Admin ID</label>
                                                                <input type="text" class="form-control" id="admin_id_recharge_modal" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="api"><span class="glyphicon glyphicon-user"></span> Admin Name</label>
                                                                <input type="text" class="form-control" id="admin_recharge_modal" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="api"><span class="glyphicon glyphicon-user"></span>Current Balance</label>
                                                                <input type="text" class="form-control" id="admin_bal_recharge_modal" disabled>
                                                            </div>
                                                            <div class="form-group">
    ...
    <script src="assets/js/_adminsEditors.js"></script>
    <script>
    $(document).ready(function () { 
        $("#nav_main_title").text("Supervisors");
    });
    $('#nav_item_supervisor').addClass("active");
</script>
</body>
