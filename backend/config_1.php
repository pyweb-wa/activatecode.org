...
// $hosts = ['192.168.100.20', '192.168.100.20','192.168.100.20'];
...
$pdo = new PDO($dsn, $user, $pass, $options);
    ...
    echo '{"ResponseCode":3,"Msg":"The current business is busy, no mobile number is available, please try again later","Result":null}';
    die();
}
